-- Railway System Database Setup Script
...
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'RailwaySystem')
BEGIN
...
PRINT 'Tables created: User, Login, Passenger, Train, Ticket, Admin, Station, Admin_Station, Schedule, Admin_Train';
